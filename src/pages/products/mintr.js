			...
			<div className="mintr-page">
				<section className="section header-section">
					<div className="container">
						<div className="header-image"><img src={mintrLogo}/></div>
				...
				<section className="section is-white mintr-about">
					<div className="container">
						<div className="section-title sp7 pt-50">Mintr is a dApp for SNX holders</div>
						...
						<div className="mintr-button"><a href={mintrUrl} target="_blank"><img src={mintrButton} /></a></div>
					</div>
				</section>
					...
					<div className="container">
						<div className="columns">
							...
							<div className="column is-half second-column">
								<div className="mintr-screenshot"><img src={mintrScreenshot} /></div>
							</div>
						</div>
					</div>
				</section>
				<section className="section is-white minting-synths">
					<div className="container">
						<div className="section-title sp2 pb-40">Minting Synths and the Collateralisation Ratio</div>
						<div className="section-desc sp4">
							Synthetix allows synthetic assets (Synths) to be minted against the value of SNX tokens. 
							This is done by locking SNX into a smart contract as collateral at a ratio of 500% to the 
							Synths minted. For example, this means that if 1000 SNX is locked at a value of $0.10 USD, 
							20 sUSD can be minted against it. 500% has been chosen to provide ample protection against 
							price fluctuations.

							<br/><br/>

							Your Collateralisation Ratio affects the proportion you receive of fees generated by Synth
							transactions. If your Ratio drops below 500%, you receive fewer fees, which you can read more
							about <a href="https://blog.synthetix.io/launch-open-minting-fee-changes/" target="_blank">here</a>. This is to incentivise SNX holders from maintaining the entire Network Collateralisation
							Ratio (i.e. value of total locked SNX against value of total Synths) as well as keeping Synth prices
							stable.
						</div>
					</div>
				</section>
