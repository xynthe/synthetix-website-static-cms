		...
		<Layout>
			<div className="mintr-page">
				...
				<section className="section is-white mintr-about">
					<div className="container">
						<div className="section-title sp7 pt-10">Mintr is a dApp for SNX holders</div>
				...
				<section className="section is-white minting-synths">
					<div className="container">
						<div className="section-title sp5 pb-40">Minting Synths and the Collateralisation Ratio</div>
