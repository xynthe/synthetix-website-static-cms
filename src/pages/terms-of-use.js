						...
						<div className="section pv-0">
							<div className="content">
								<ol type="1" className="terms-of-use-list">
									<li>
										<span>Terms</span>
										 <br /> By accessing the website at http://havven.io, you are agreeing to be
									...
									<li>
										...
										 <br />
										The materials on Havven's website are provided on an 'as is' basis. Havven makes
										no warranties, expressed or implied, and hereby disclaims and negates all other
										warranties including, without limitation, implied warranties or conditions of
										merchantability, fitness for a particular purpose, or non-infringement of
										intellectual property or other violation of rights. Further, Havven does not
									...
									<li>
										...
										 <br />
										In no event shall Havven or its suppliers be liable for any damages (including,
										without limitation, damages for loss of data or profit, or due to business
										interruption) arising out of the use or inability to use the materials on
										Havven's website, even if Havven or a Havven authorized representative has been
									...
									<li>
										...
										 <br />
										The materials appearing on Havven website could include technical,
										typographical, or photographic errors. Havven does not warrant that any of the
										materials on its website are accurate, complete or current. Havven may make
										changes to the materials contained on its website at any time without notice.
										However Havven does not make any commitment to update the materials.
									</li>
									<li>
										<span>Links</span>
										 <br />
										Havven has not reviewed all of the sites linked to its website and is not
										responsible for the contents of any such linked site. The inclusion of any link
										does not imply endorsement by Havven of the site. Use of any such linked website
										is at the user's own risk.
									</li>
									<li>
										<span>Modifications</span>
										 <br />
										Havven may revise these terms of service for its website at any time without
