						...
						<div className="section pv-0">
							<div className="content">
								<ol type="1" className="terms-of-use-list">
									<li>
										<span>Terms</span>
										 <br /> By accessing the website at http://synthetix.io, you
									...
									<li>
										...
										 <br />
										The materials on Synthetix’s website are provided on an 'as
										is' basis. Synthetix makes no warranties, expressed or
										...
										other violation of rights.  Further, Synthetix does not
									...
									<li>
										...
										 <br />
										In no event shall Synthetix or its suppliers be liable for
										...
										Synthetix’s website, even if Synthetix or a Synthetix
									...
									<li>
										...
										 <br />
										The materials appearing on the Synthetix website could
										include technical, typographical, or photographic errors.
										Synthetix does not warrant that any of the materials on its
										website are accurate, complete or current. Synthetix may
										make changes to the materials contained on its website at
										any time without notice. However Synthetix does not make any
										commitment to update the materials.
									</li>
									<li>
										<span>Links</span>
										 <br />
										Synthetix has not reviewed all of the sites linked to its
										website and is not responsible for the contents of any such
										linked site. The inclusion of any link does not imply
										endorsement by Synthetix of the site. Use of any such linked
										website is at the user's own risk.
									</li>
									<li>
										<span>Modifications</span>
										 <br />
										Synthetix may revise these terms of service for its website
									...
									<li>
										...
										accordance with the laws of New South Wales, Australia and
