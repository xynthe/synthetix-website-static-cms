				...
				<div className="home-page">
					<section className="section pb-30">
						<div className="container">
							...
							<div className="page-subtitle">
								Havven enables stable, censorship resistant payments for dApps in multiple currencies. Our stablecoins are backed by a network of eighty thousand token holders around the world.
							</div>
					...
					<section className="section currency-section pb-110 pt-70">
						...
						<div className="section-desc">
							Our stablecoin, nomins, are currently available in nUSD with nEUR, nJPY, nKRW, nAUD, nXAU, and more coming in the near future!
						</div>
					</section>
					...
					<section className="section is-white is-padded pb-110">
						...
						<div className="section-desc pb-70">HAV holders who mint nomins are entitled to receive fees generated by nomin transactions.</div>
						<div className="columns is-centered get-rewarded-boxes">
							<a className="column" href="https://dashboard.havven.io/" target="_blank">
								...
								<div className="c-bottom">
									...
									<div className="p3">
										An overview of the Havven network
									</div>
								</div>
							</a>
					...
					<section className="section is-grey is-padded">
						...
						<div className="columns is-centered feature-boxes">
							<div className="column">
								...
								<div className="p2">A distributed pool of token holders are responsible for maintaining stability.</div>
							</div>
							<div className="column">
								<div className="c-img">
