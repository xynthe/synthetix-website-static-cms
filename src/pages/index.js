					...
					<section className="section pb-30">
						<div className="container">
							...
							<div className="page-subtitle">
								Havven enables stable, censorship resistant payments for dApps in over 10
								currencies. Our stablecoins are backed by a network of over eighty thousand
								collateral holders around the world.
							</div>
					...
					<section className="section is-grey is-padded">
						...
						<div className="columns is-centered feature-boxes">
							...
							<div className="column">
								...
								<div className="p2">
									Collateral is provided by a distributed network of HAV holders, which means it
									can’t be seized by institutions.
								</div>
							</div>
							<div className="column">
								<div className="c-img">
								...
								<div className="p2">
									Our collateral is fully visible on the blockchain and does not require auditing
									from a third party.
								</div>
							</div>
						</div>
