					...
					<section className="section header-section">
						<div className="container">
							...
							<div className="page-subtitle">
								Synthetix is launching its synthetic asset platform on EOSIO, and 50% of all SNXeos
								tokens are being distributed to SNX holders on Ethereum!
							</div>
						</div>
					</section>
					<section className="section is-white steps-section pt-80">
						<div className="container">
							...
							<div className="sd-1 section-desc pb-50">
								The SNXeos Distribution will reward SNX(eth) holders for supporting the project,
								allowing them to help enable stable payments on the EOSIO blockchain. In the
								Synthetix Network, SNX is the collateral token that backs Synths such as sUSD. Over
								$1.5m sUSD has already been minted by SNXeth holders!
							</div>
						</div>
